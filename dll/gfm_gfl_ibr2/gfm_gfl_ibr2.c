...
IEEE_Cigre_DLLInterface_Signal InputSignals [] = {
  ...
  [7] = {
    ...
    .Unit = "kA", 
    .DataType = IEEE_ Cigre_DLLInterface_DataType_real64_ T, 
    .Width = 1 
  },
  [8] = {
    .Name = "I2c", 
...
IEEE_Cigre_DLLInterface_Signal OutputSignals[] = {
  ...
  [7] = {
    ...
    .Unit = "N/A", 
    .DataType = IEEE_ Cigre_DLLInterface Data Type_real64_T, 
    .Width = 1 
  }, 
  [8] = {
    .Name = "Output_5", 
...
IEEE_Cigre_DLLInterface_Parameter Parameters[] 
  ...
  [l] = {
    ...
    .MinValue.Real64_Val = 0.001, 
    .MaxValue.Real64 Val = 100000000.0 
  },
...
.DataType = IEEE_Cigre_DLLInterface_DataType_real64_T, 
.FixedValue = 0, 
.DefaultValue.Real64_ Val = 0 00001, 
.MinValue.Real64 Val = 0.0, 
.MaxValue.Real64 Val= 10.0 
...
.MinValue.Real64_ Val = 0.0, 
.MaxValue.Real64 Val = 1.0 
...
.Unit = "N/A" , 
.DataType = IEEE_ Cigre_DLLInterface _Data Type_real64 _ T , 
.FixedValue = 0, 
.DefaultValue.Real64_ Val = 1.0, 
.MinValue.Real64_Val = 0.0, 
.MaxValue.Real64 Val= 1000.0 
...
.Unit = "pu/pu", 
.DataType = IEEE_ Cigre_DLLInterface_Data Type_real64 _ T , 
.FixedValue = 0, 
...
.DataType = IEEE_Cigre_DLLInterface_DataType_real64_T, 
.FixedValue = 0, 
.DefaultValue Real64_ Val = 324, 
.MinValue.Real64_ Val = 0.001, 
.MaxValue.Real64 Val= 1000.0 
...
.DataType = IEEE_ Cigre_DLLInterface _Data Type_real64 _ T.
.FixedValue = 0, 
.DefaultValue.Real64_ Val = 2 * PI 60, 
.MinValue.Real64_ Val = 1.0, 
.MaxValue Real64 Val = 1e8 
...
.DataType = IEEE_Cigre_DLLInterface_DataType_real64_T, 
.FixedValue = 0, 
.DefaultValue Real64_ Val = 1200, 
.MinValue.Real64_ Val = 0.0, 
.MaxValue.Real64 Val= 10000.0 

 [l4] = {
 },
.Name = "VI_flag", 
.Description = "1: enable PPS VI characteristic, O: constant I", 
.Unit = "NIA", 
.DataType = IEEE_ Cigre_DLLinterface _Data Type_real64 _ T.
.FixedValue = 0, 
...
.Unit = "pu/pu", 
.DataType = IEEE_ Cigre_DLLInterface_Data Type_real64_T 
.FixedValue = 0, 
.DefaultValue.Real64_Val = 0.0, 
.MinValue.Real64_Val = 0.0, 
.MaxValue Real64 Val = 1.0 
...
.DataType = IEEE_Cigre_DLLInterface_DataType_real64_T, 
.FixedValue = 0, 
.DefaultValue.Real64_ Val = 5 .18, 
.MinValue.Real64_ Val = 0.001, 
.MaxValue.Real64 Val = 1 000 .0 

 [l8] = {
 },
.Name = "Ki_ Vdc", 
.Description = "Integral gain for Vde", 
.Unit = "pulpu", 
.DataType = IEEE_Cigre_DLLInterface_DataType_real64_T, 
.FixedValue = 0, 
...
.Unit = "s", 
.DataType = IEEE_ Cigre_DLLinterface DataType_real64_T.
.FixedValue = 0, 
.DefaultValue Real64_ Val = 0.1, 
.MinValue.Real64 Val = 0.0, 
.MaxValue Real64 Val = 1.0 
...
.DataType = IEEE_Cigre_DLLInterface_DataType_real64_T, 
.FixedValue = 0, 
.DefaultValue.Real64_ Val = -0 0006, 
.MinValue.Real64_ Val = -Ie8, 
.MaxValue.Real64 Val= 0.0 
...
.DataType = IEEE_Cigre_DLLInterface_DataType_real64_T, 
.FixedValue= 0, 
.Default Value.Real64_Val = 0.0, 
.MinValue.Real64 Val = 0.0, 
.MaxValue.Real64 Val = I 00 0 
...
.DataType = IEEE_Cigre_DLLInterface_DataType_real64_T, 
.FixedValue= 0, 
.Default Value.Real64_ Val = 0.001, 
.MinValue.Real64 Val = 0, 
.MaxValue.Real64 Val = I 00 0 

 [25] = {
 },
.Name = "Vdc_flag", 
.Description - "dc control flag (I: enable, 0: const.PQ), 
.Unit = "N/A", 
.DataType = IEEE_Cigre_DLLInterface_DataType_real64_T, 
.FixedValue= 0, 
.DefaultValue.Real64_Val = 0.0, 
.MinValue.Rcal64_Val = 0.0, 
.MaxValue.Real64 Val = I.0 

 [26] = {
 },
.Name = "f_flag", 
.Description = "Frequency flag (I: enable frequency droop control)", 
.Unit = "N/A", 
.DataType = IEEE_Cigre_DLLInterface_DataType_real64_T, 
.FixedValue = 0, 
.DefaultValue.Real64_Val = 0.0, 
...
.DataType = IEEE_Cigre_DLLInterface_DataType_real64_T, 
.FixedValue = 0, 
.DefaultValue.Real64_ Val = 0 .4, 
.MinValue.Real64_Val= le8, 
.MaxValue Real64 Val = 1 e8 
...
.Name = "Qctl_CL_flag", 
.Description = "1: enables closed loop Q control, O: open loop", 
.Unit = "N/A", 
.DataType = IEEE_ Cigre_DLLInterface _Data Type_real64 _ T.
.FixedValue = 0, 
.DefaultValue.Real64_ Val = 1.0, 
...
.Name = "Vt_flag", 
.Description = "l· enable inverter term.voltage control, o· Q control", 
.Unit = "N/A", 
.DataType = IEEE_ Cigre_DLLInterface _Data Type_real64 _ T.
.FixedValue = 0, 
.DefaultValue.Real64_ Val = 1.0 .
...
.DataType = IEEE_ Cigre_DLLInterface_Data Type_real64 _ T , 
.FixedValue = 0, 
.DefaultValue.Real64_ Val = 0.32325, 
.MinValue.Real64_Val 0.0, 
.MaxValue.Real64 Val = 1 e8 
...
.DataType = IEEE_Cigre_DLLInterface_DataType_real64_T, 
.FixedValue = 0, 
.DefaultValue.Real64_ Val = 99999, 
.MinValue.Real64_Val = 0 0, 
.MaxValue.Real64 Val = 1 e8 
...
.FixedValue = 0, 
.DefaultValue.Real64_Val = 0.0001, 
.MinValue.Real64_ Val = 0.000001, 
.MaxValue.Real64 val = 1 0 .0 
...
II used during code generation 
.ModelName = "!BR-Average-Model", 
.ModelVersion = "1.1.0.0", 

.ModelDescription = "GFD-IBR-Average", 
.GeneralInformation= "General Information" 
.ModelCreated = "September 21, 2023", 

.ModelCreator = "Vishal Verma", 

.ModelL astModifiedDate= "September 21, 2023", 
.ModelLastModifiedBy = "Vishal Verma", 

.ModelModifiedComment = "Version 1 .1.0.0 for IEEE/ Cigre DLL AP! 
.ModelModifiedHistory = "First instance", 
.FixedStepBaseSampleTime= 0.00001, 

II Inputs 

.NumlnputPorts = 15, 

.InputPortslnfo = InputSignals 

/ Outputs 

.NumOutputPorts 13, 

.OutputPortslnfo = Output Signals , 
...
II Model   created on     
II Model   created by     
II Model   last   modified on     
II Model   last   modified by     
", II Model   modified comment     
II Model   modified   history     
II   Time   Step   sampling ti me   (sec)   II Number of Input Signals 

// Inputs structure defined above 

II Number of Output Signals 

II Outputs structure defined above 

II Number of Parameters 

II Parameters structure defined above 

II Number of State Variables 
.NumlntStates = 0, 
...
II Number of Integer states 
II Number of Float states 

II Number of Double states 

} ; 
II 

II Subroutines that can be called by the main power system program 
II 

declspec(dllexport) Const IEEE_Cigre_DLLInterface_Model_Info# 
/k Returns Model Information 
...
cdecl Model_ Getlnfo () 

II 

__declspcc(dllcxport) int32_T__cdccl Model_ChcckParameters(IEEE_Cigre_DLLInterface_Instance instance) 
...
II Parameter checks done by the program 

II Note - standard minimax checks should be done by the higher level GUI/ Program 
...
double Tp _ droop = parameters ->Tp _droop; 
...
double Vt_ref - parameters Vt ref; 
...
double delt = Model Info.FixedStepBaseSampleTime; 
...
but has been reset to be reciprocal of 2 times the time step: %f .An" KiPLL.delt); 

parameters->KiPLL = 1.0 / (2.0 delt); 

} 

II ((1.0 / Ki_Vdc) < 2.0 delt) { 

II write error message 

sprintf_s(ErrorMessage, sizeof(ErrorMessage), "GFL-IBR Error - Parameter Ki_Vdc is: %f, 
but has been reset to be reciprocal of 2 times the time step %f n", Ki_Vdc, delt):; 
...
but has been reset to be reciprocal of 2 times the time step: %f .In", Kv_i, delt); 
...
if ((1 0 I Kcc_i) < 2.0 * delt) 
II write error message 

sprintf_s(ErrorMessage, sizeof(ErrorMessage), "GFL-IBR Error - Parameter KiV is: %f, 
but has been reset to be reciprocal of 2 times the time step: %f .In", Kcc_i, delt); 
parameters->Kcc_i = 1.0 / (2.0 * delt); 

instance->LastGeneralMessage = ErrorMessage; 
return IEEE_ Cigre_DLLInterface_Return_ OK; 

}; 
II 

declspec(dllexport) int32_T cdecl Model_Initialize(IEEE_Cigre_DLLInterface_Instance# instance) 

/k Initializes the system by resetting the internal states 

Arguments.Instance specific model structure containing Inputs, Parameters and Outputs 

Return: Integer status 0 (normal), I if messages are written , 2 for errors.

See IEEE_ Cigre_DLLIterface _types.h 

%/ 

II 

/l Note that the initial conditions for all models are determined by the main calling program 
...
double   eurrTIME =   inputs ->currTIME;   II Working back from initial output 
...
double INIEGRATOR(donble T, double x, double x_old, double y old, double dell) { 
double y, 
...
II Integrator with time constant T and reset value rst_val 
...
II PI with gain Kand integrator with time constant T 

double PICONTROLLER(donble K, double T, double x, double x_old, double y_old, double dell) { 
double y; 
...
II first order lag with gain G, time constant T, with non-windup internal limits 

double REALPOLE(donble G, double T, double x, donble x_old, double y_old, double ymin, double ymax, 
double dell) { 
...
II second order complex pole with gain G, time constant T, damping B.Only first state represented as C junction 
donble CMPLXPOLE(double G, double T, double B, donble x, double x_old, double yp_old, donble y_old, 
...
II In main code, use yp to evaluate integration of final output y 
return yp; 
...
I I rectangular to polar transformation 
...
II polar to rectangular transformation 
...
II comparatror to compare two inputs 
...
II limiter to limit the output within bounds 
...
II selector selects a input based on flag condition , input_A if FLAG is true 
double SELECTOR(double input_A, donble input_B, double FLAG) { 
...
II sample and hold block to hold the output to its last value if a flag is provided 
void SAMPLEHOLD(double signal_in , double FLAG, double FLAG OLD, double sample_hold) 

II sample_hold[O} = output ( signal_out) 
...
II rate limiter to limit the rate of change of output 

double RATEL!l\:IITER(double f_input, double Oldf_output, double rate_up, double rate_down, double dell) { 
...
II to convert DQ quantities to ABC 
...
II to convert ABC quantities to Alpha-Beta 
...
I I to convert alpha beta to DQ 
...
II to calculate mod of 2 float numbers 
...
II real power using alpha beta 
...
double OldVt_beta = instance-DonbleStates [23], 
...
double Oldlq_VtdCLIin = instance-DoubleStates[56]; 
...
double Olductrld_1Iin = instance >Doubl€States[68]; 
...
double Oldnuctrlq_IIin instance-DoubleStates[72]; 
...
ii double currTIME; removed on 3/14 
II Signal Processing block 
...
double Iq_VtdCLe, Iq_ VtdCLP, Iq_ VtdCLIin, Iq_VtdCLI, Iq VtdCLAW, Iq_VtdCL, Iq_ VtdCLAWerr; 
double Qdq_x, Qdq; 

double lq_ QCLe, Iq _QCLP, Iq_QCLIin, IA_QCLI, Iq QCLAW, Iq QCL, IA QCLAWerr; 
double lq_QOL, 
...
donble Magldql, Magldq2, Angldq_12; 
...
double uctrld IP uctrld !Jin uctrld II 

- - - 

double uctrlq_lP uctrlq_llin uctrlq_ll 

double uctrld 2P uctrld 2Iin uctrld 21 
...
Vtc_fII = REALPOLE(I, TfIt_V, VIC_Pu, OIdVtc_pu, OldVtc_fII, Ie8, Ie8, delt); 
Vtc flt = SELECTOR(Vtc flt!, Vtc_pu, Vflt_flag ); 

II Current Filtering 

Ila flt! = REALPOLE(l, TFIt_i, Ila_pu, OldI1a_pu, OldI1a_fIt1, 1e8, 1e8, delt ): 

Ila_flt = SELECTOR(Ila_fltl, Ila_pu, Iflt_flag ); 

IIb_fItI= REALPOLE(I, TfIt_i, IIb_pu, OldHIb_pu, OldIIb_fItI,-Ie8, 1e8, delt); 
I I b _flt = SELECTOR( I I b _flt 1.I I b _pu, I flt_ flag ) ; 

IIc_III= REALPOLEI, TRI_i , II€_pu, OIdIIc_Pu, OldIIc_fII, le8, 1e8, delt); 
I I c _flt = SELECTOR( I I c _ fl t1, Ilc_pu, I flt_ flag ) , 
...
Vtdq_l [ 0]; I I Output #I 

Vtdq_l [ l]; I I Output #2 
...
Vtdq_2 [0]; II Output #3 

Vtdq_2[1]; II Output #4 

/ Anti Wind Up Code Begin w! 

DelOmegaP = vtq_1 KpPLL; II Proportional term 

DelOmegalin = (Vtq_l - OldDelOmegaAWerr) KiPLL; 

II Input lo Integral Controller 
...
Omega_PLL = w_nom + Del Omega; I I Output #5 

II Update DelOmegaAWerr for next time step 
...
II Currents block of Signal and Processing (DDSRF approach)         
...
Iq_2 = Idq2_flt [IJ   Idlr flt k sin(Theta PLL % 2)   Iqlr_flt cos(Theta PLL k 2),   I I Power Calculations 

II ABC to ALPHA-BETA.values used from DSOGI calculations 
II ABC to ALPHA-BETA currents 
...
II Input Flag to Current Controller, Vdip logic 
...
Id! Vdciin = (Vdc ref Vdc meas * 1000 - Oldidl VdcAWerr) * Ki Vdc; 

II Input lo Integral Controller 

Id! VdcI = INI'EGRATORRESET(l, Startup_flag, 0, Idl_Vdciin, Old!dl_Vdclin, Oldidl_Vdcl, dell); 
...
II Update Idl_VdcAWerr for next time step 
...
II Idlref_cont continuous 

SAMPLEHOLD(Idlref_conl, FRT_flag, OldFRT_flag, Idlref_hold_SH); 

II Idlref_hold = S4MPLEHOLD(Idlref_cont, Oldidlref_hold, FRT_Jlag); 
Idlref_hold = Idlref_hold_SH [OJ, II Idlref_hold is output of Sample and Hold 
...
II Input to Integral Controller 
...
II Update AWerr for next time step 
...
Iq_QCLP = Iq_QCLe * Kq_p; II Proportional term 

Iq_QCL!in = (Iq_QCLe - Oldlq_QCLAWerr) * Kq_i; 

II Input to Integral Controller 

Iq_QCLI = INTEGRATORRESET(I, Startup_flag .0, Iq_QCLIin, Oldlq_QCLIin, Oldlq QCLI, delt); 
...
II Generating Idlref_L, Iqlref_L, Jdref_2_L, Iq2ref_L 
...
II Cont ..Calculate Ia_max , Ib_max, Jc_max 
...
II Generating Jdlref_L2, Iqlref_L2, Jdref_2_L2, Iq2ref_L2 
...
II Input Currents lo Current Controller 
...
uctrld IP = Idl_e * Kcc_p; II Proportional term 

uetrld 1Iin = (Id1 e Olductrld IAWerr) Kc i; 

II Input to Integral Controller 

uetrld II = INI'EGRATORRESET(l, 0, 0, uetrld IIin Olduelrld IIin, Olduetrld II, dell); 

uctrld 1AW = uctrld 1P + uctrld II; 
...
uclrlq_lP = Iql_e * Kcc_p; II Proportional term 
uclrlq_llin = (Iql_e - Oldnuctrlq_1AWerr) # Kcc_i; 

II Input to Integral Controller 

uetrlq_lI = INI'EGRATORRESET(l, 0, 0, uetrlq_liin, Olduelrlq_liin, Olduetrlq_lI, dell); 
...
uctrld 2P = Id2_e * Kcc_p; II Proportional term 
...
uelrld 21 = INTEGRATORRESET(1, 0, 0, uctrld 2Iin Olduclrld 2lin, Olduelrld 21, dell); 
...
uetrlq_2P = lq2_e * Kee_p; II Proportional term 
...
II Generate Ed_l, Eq_l, Ed_2, and Eq_2 
...
Vtq_2y = REALPOLE(I, Tau_VII, Vtq_2, Oldvtq_2, Oldvtq_2y, 99999, 99999, de It); 

Eq_2 = SELECTOR(Vtq_2y, 0.0, Vff_flag) * Vdq_base - (Id_2 * Lchoke * w_nom * ldq_base) + uctrlq_2, 

I I Generate output Eal, Ebl, Eel 

DQ2ABC(Ed_1.Eq_l, Theta PLL.Eabc_1).

I I Generate output Ea2, Eb2, Ec2 

DQ2ABC(Ed_2, Eq_2, -Theta_PLL, Eabc_2); 

I I Check modulation index 
...
II Added outputs for debugging 

II save state variables 
...
pr in tf("Model modified comment: %s\n" , Model_Info.ModelModifiedComment); 
