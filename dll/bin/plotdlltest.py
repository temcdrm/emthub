...
plots = {
  "ibr2.csv": {"tmin": 0.0, "tmax": 1.4, "ttick": 0.2, "title": "IBR v2 Test",
                "ytitles": ["Voltage [kV]", "Current [kA]", "Control [pu]", "dq [pu]"],
                "signals": [{"name": "Vta", "base": 1.0, "axis": 0},
                            {"name": "Vtb", "base": 1.0, "axis": 0},
                            {"name": "Vtc", "base": 1.0, "axis": 0},
                            {"name": "I1a", "base": 1.0, "axis": 1},
                            {"name": "I1b", "base": 1.0, "axis": 1},
                            {"name": "I1c", "base": 1.0, "axis": 1},
                            {"name": "FreqPLL", "base": 60.0, "axis": 2},
                            ...
                            {"name": "FRT_Flag", "base": 1.0, "axis": 2},
                            {"name": "Id1", "base": 1.0, "axis": 3},
                            {"name": "Iq1", "base": 1.0, "axis": 3},
                            {"name": "Vtd1", "base": 1.0, "axis": 3},
                            {"name": "Vtq1", "base": 1.0, "axis": 3}]},
  ...
  "sexs.csv": {"tmin": 0.0, "tmax": 0.8, "ttick": 0.1, "title": "SEXS Excitation System Test",
                ...
                "signals": [{"name": "Vref", "base": 1.0, "axis": 0},
                            {"name": "VcOLS", "base": 1.0, "axis": 0},
                            {"name": "VcOLD", "base": 1.0, "axis": 0},
                            {"name": "VcCL", "base": 1.0, "axis": 0},
                            {"name": "EfdOLS", "base": 1.0, "axis": 1},
                            {"name": "EfdOLD", "base": 1.0, "axis": 1},
                            {"name": "EfdCL", "base": 1.0, "axis": 1}]},
