...
if __name__ == '__main__':
  ...
  for key in ['EMTBaseVoltage', 'EMTIBRPlantAttributes', 'EMTIEEECigreDLL', 
              'EMTCountDLLParameters', 'EMTIEEECigreDLLParameters*', 'EMTCountDLLInputs', 'EMTIEEECigreDLLInputs*', 'EMTCountDLLOutputs', 'EMTIEEECigreDLLOutputs*']:
