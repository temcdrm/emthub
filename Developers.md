...
- `pip install -i https://test.pypi.org/simple/ emthub==0.0.8` for local testing of the deployable package, example version 0.0.8 (Note: consider doing this in a separate Python test environment)
